...
var delimiter = ", \n";
var inner_indent = "Å@Å@";
this.level += 1;
if(this.maxLevel < this.level){
return ""+this.maxLevel+"äKëwà»è„ÇÕè»ó™ÇµÇ‹Ç∑";
}
var str = "";
for (key in obj) {
...
div_parent.innerHTML = "<div class=\"loading\"><img text=\"loading\" alt=\"loading\" src=_255c.UNKNOWN"" + _nc_core_base_url + "/images/common/indicator.gif\"/></div>";
...
winlogger.document.write("<HTML><HEAD><link rel=\"stylesheet\" type=\"text/css\" media=\"screen\" href=_255c.UNKNOWN""+_nc_core_base_url + _nc_index_file_name + "?action=common_download_css&amp;dir_name=/css/common.css&amp;header=0"+"\" /></HEAD><BODY>");
...
"height=200,width=400,menubar=yes,scrollbars=yes,resizable=yes");
winlogger.document.open("text/html", "replace");
winlogger.document.write("<HTML><HEAD><link rel=\"stylesheet\" type=\"text/css\" media=\"screen\" href=_255c.UNKNOWN""+_nc_core_base_url + _nc_index_file_name + "?action=common_download_css&amp;dir_name=/css/common.css&header=0"+"\" /></HEAD><BODY>"+res+"</BODY></HTML>");
winlogger.document.close();
winlogger.focus();
...
html += "<script src=_255c.UNKNOWN""+_nc_core_base_url + _nc_index_file_name + "?action=common_download_js&amp;header=0"+"\"></script>";
...
var linkText = "<link rel=\"stylesheet\" type=\"text/css\" media=\"print\" href=_255c.UNKNOWN""+_nc_core_base_url + _nc_index_file_name + "?action=common_download_css&amp;dir_name=/css/print.css&amp;header=0"+"\" />";
linkText += "<link rel=\"stylesheet\" type=\"text/css\" media=\"all\" href=_255c.UNKNOWN""+_nc_core_base_url + _nc_index_file_name + "?action=common_download_css&amp;dir_name=/css/print_preview.css&amp;header=0"+"\" />";
...
div.innerHTML='<iframe src="about_3ablank.UNKNOWN" name="' + form_target + '" style="width:0px;height:0px;"></iframe>';
...
var em_num = "ÇOÇPÇQÇRÇSÇTÇUÇVÇWÇXÅDÅC??Å{";
var str = "";
...
text += "<html " + htmlAttr + ">\n";
text += "<head><meta http-equiv=\"Content-Type\" content=\"text/html; charset=Shift_JIS">" + titleText + linkText + "</head>\n";
...
var self = this;
self.js_path = _nc_base_url + _nc_index_file_name + "?action=common_download_js&add_block_flag=1&dir_name=";
self.css_path = _nc_base_url + _nc_index_file_name + "?action=common_download_css&header=0&dir_name=/comp/plugins/";
...
chgseq_params["param"] = {"action":"journal_action_edit_categoryseq", "category_id":category_id,
...
updItems: function(event, this_el, category_id) {
var top_el = $(this.id);
...
del_params["param"] = {"action":"journal_action_edit_categorydel","category_id":category_id};
